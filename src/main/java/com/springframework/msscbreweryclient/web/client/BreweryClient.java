...
@Component
@ConfigurationProperties(value = "sfg.brewery", ignoreUnknownFields = false) // prefix
public class BreweryClient {
    ...
    // Spring will inject a RestTemplateBuilder Instance
    // and in the constructor we initialize the restTemplateBuilder
